                    ...
                    <div class="bento-card" style="margin-top: 1.5rem;">
                        <div class="card-header">
                            ...
                            <div style="display:flex; gap: 0.6rem; align-items: center;">
                                ...
                                <button class="btn-more" id="btn-nuevo-articulo"><i class="fa-solid fa-plus"></i> Nuevo</button>
                            </div>
                        </div>
                    ...
                    <div class="bento-grid" style="grid-template-columns: 1fr;">
                        <div class="bento-card">
                            <div class="card-header">
                                ...
                                <button class="btn-more">Descargar reporte</button>
                            </div>
                    ...
                    <div class="bento-grid" style="grid-template-columns: 1fr;">
                        <div class="bento-card">
                            <div class="card-header">
                                ...
                                <button class="btn-more">Nueva Compra</button>
                            </div>
                            <div class="table-responsive">
                                <table class="recent-sales-table">
                                    <thead>
