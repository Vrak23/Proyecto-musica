...
switch ($method) {
    ...
    case 'PUT':
        ...
        $stmt = $conn->prepare("UPDATE CLIENTES SET DNI=?, NOMBRE=?, APELLIDOS=?, EMAIL=?, TELEFONO=?, DIRECCION=? WHERE ID_CLIENTE=?");
        $stmt->bind_param("ssssssi", $dni, $nombre, $apellidos, $email, $telefono, $direccion, $id);
